...
/**
 * RenderPipelineModule manages multi-layer canvas rendering:
 ...
 */
export class RenderPipelineModule extends BaseModule {
  constructor(engine) {
    super(engine);
  ...
  detach() {
    ...
    console.log("RenderPipelineModule detached");
  }
